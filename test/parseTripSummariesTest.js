...
`
    ...
    expect(summaries).to.deep.equal([
      ...
      },
      {
        ...
        excludedFootage: 0,
        numExcludedShots: 0,
        surveyors: ['Peter Quick', 'Chris Gerace', 'Phil Oden', 'Chip Hopper'],
        shots: [
          'A13 SIDE',
          'B1-B5',
          'B2 SIDE',
      ...
      },
      {
        ...
        numShots: 51,
        name:
          'CHRIS CROSS CONTINUED, FRIENDLY PASSAGE TO FISHER RIVER (VIA CLIMB DOWN)',
